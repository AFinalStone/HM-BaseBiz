...
public class FileUtil {
    ...
    public static String getExternalCacheDirPath(@NonNull Context context) {
        ...
        int granted = context.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE, android.os.Process.myPid(), Process.myUid());
        if (PackageManager.PERMISSION_GRANTED == granted && hasSdcard()) {
